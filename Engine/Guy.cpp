...
void Guy::ClampScreen()
{
	const int right = x + Guy::Width;
	if (x < 0)
	{
		x =  0;
	}
	...
	{
		x =  (Graphics::ScreenWidth - 1) - Guy::Width;
	}
	
	const int bottom = y + Guy::Height;
	if (y < 0)
	{
		y =  0;
	}
	...
	{
		y =  (Graphics::ScreenHeight - 1) - Guy::Height;
	}
	
}

void Guy::Draw(Graphics & gfx)
{
...
void Guy::Update(const Keyboard& kbd)
{
...
int Guy::GetWidth() const
{
	return Width;
}

int Guy::GetHeight() const
{
	return Height;
}
